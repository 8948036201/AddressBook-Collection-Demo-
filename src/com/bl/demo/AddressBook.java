...
public class AddressBook {
	...
	private static void deleteContact(Scanner scanner) {
		System.out.println(
				"Which contact you want to Delete? (Enter the First name)");
		...
		if (deleteContact == null) {
			System.out.println(
					"No contact found with name " + firstName + ".");
		} else {
			System.out.println(deleteContact.getFirstName()
					+ "'s contact has been removed from your Address Book.");
		}
	}

	private static void editContact(Scanner scanner) {
		System.out.println(
				"Which contact you want to Edit? (Enter the First name)");
		String firstName = scanner.nextLine();
	...
	private static void editContactDetails(Contact editContact,
			Scanner scanner) {
		System.out.println("Enter First Name: ");
		String firstName = scanner.nextLine();
		editContact
				.setFirstName(validateFirstName(firstName, scanner));
		...
		editContact
				.setPhoneNumber(validatePhone(phoneNumber, scanner));
	...
	public static String validateFirstName(String firstName,
		...
		while (!inputMatcher.matches()) {
			...
			System.out.println(
					"length must not exceeds 10 (Exa: Darpan)");
